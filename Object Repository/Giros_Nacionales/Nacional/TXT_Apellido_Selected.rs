...
<MobileElementEntity>
   ...
   <name>TXT_Apellido_Selected</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Apellido paterno' or . = 'Apellido paterno') and @resource-id = '']</locator>
