...
<MobileElementEntity>
   ...
   <name>TXT_NroDocumento_Selected</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Nro. de Documento' or . = 'Nro. de Documento') and @resource-id = '']</locator>
