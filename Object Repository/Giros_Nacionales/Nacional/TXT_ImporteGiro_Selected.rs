...
<MobileElementEntity>
   ...
   <name>TXT_ImporteGiro_Selected</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Importe de giro' or . = 'Importe de giro') and @resource-id = '']</locator>
