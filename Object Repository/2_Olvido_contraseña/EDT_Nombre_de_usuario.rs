...
<MobileElementEntity>
   ...
   <name>EDT_Nombre_de_usuario</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Nombre de usuario' or . = 'Nombre de usuario') and @resource-id = '']</locator>
