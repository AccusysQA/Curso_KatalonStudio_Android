...
<MobileElementEntity>
   ...
   <name>EDT_Correo_electronico</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Correo electrónico (Opcional)' or . = 'Correo electrónico (Opcional)') and @resource-id = '']</locator>
