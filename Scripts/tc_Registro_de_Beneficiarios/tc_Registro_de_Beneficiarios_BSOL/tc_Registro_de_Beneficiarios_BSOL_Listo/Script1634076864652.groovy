...
for (def numRow = 1; numRow <= findTestData('Registro_Beneficiario/Registro_Bsol').getRowNumbers(); numRow++) {
    ...
    Mobile.setText(findTestObject('4_Registro_Banco_Sol/EDT_Numero_Cta'), findTestData('Registro_Beneficiario/Registro_Bsol').getValue(1, numRow), 
        0)
    ...
    Mobile.setText(findTestObject('4_Registro_Banco_Sol/EDT_Propietario'), findTestData('Registro_Beneficiario/Registro_Bsol').getValue(2, numRow), 
        0)
