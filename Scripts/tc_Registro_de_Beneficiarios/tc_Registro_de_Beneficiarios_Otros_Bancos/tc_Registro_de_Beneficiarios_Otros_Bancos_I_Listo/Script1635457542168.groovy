...
for (def numRow = 1; numRow <= findTestData('Registro_Beneficiario/Registro_ACH_Cuenta_I').getRowNumbers(); numRow++) {
    ...
    if (findTestData('Registro_Beneficiario/Registro_ACH_Cuenta_I').getValue(1, numRow).trim() == 'Cooperativa Asuncion Ltda') {
    ...
    if (findTestData('Registro_Beneficiario/Registro_ACH_Cuenta_I').getValue(2, numRow) == 'Corriente') {
    ...
    //Mobile.delay(2, FailureHandling.STOP_ON_FAILURE)
    if (findTestData('Registro_Beneficiario/Registro_ACH_Cuenta_I').getValue(3, numRow) == 'Tarija') {
    ...
    Mobile.setText(findTestObject('5_Registro_ACH/EDT_Numero_de_cuenta'), findTestData('Registro_Beneficiario/Registro_ACH_Cuenta_I').getValue(4, numRow), 
        0)
    ...
    Mobile.setText(findTestObject('5_Registro_ACH/EDT_Nombre_del_beneficiario'), findTestData('Registro_Beneficiario/Registro_ACH_Cuenta_I').getValue(5, 
            numRow), 0)
    ...
    if (findTestData('Registro_Beneficiario/Registro_ACH_Cuenta_I').getValue(6, numRow) == 'B') {
